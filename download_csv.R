download_csv <- function(volume=1, to.df=TRUE, return.response=FALSE, vb=FALSE) {
  ...
  if (status_code(r) == 200){
    ...
    if (vb) cat(paste('Download Failed, HTTP status ', status_code(r), '\n', sep="" ))
